...
**Ключевые свойства / Favorites:** таблица primary-свойств для `Bin/ClDesc/.../Favorites` (`{CompName}:Prop`); secondary (`Activity`, `Coord`, `Name`, `TimeStep`, debug…) не включать; опционально curated nested I/O aliases. См. `Docs/ClDesc-Detailed-Methodology.md`.
